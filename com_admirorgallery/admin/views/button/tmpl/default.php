...
<?php
$folders = JFolder::listFolderTree(JPATH_SITE . $itemUrl, "");
$iitemUrlLenght = strlen($itemUrl);

if (!empty($folders))
{
	foreach ($folders as $foldersValue)
	{
		$folderName = substr($foldersValue['relname'], $iitemUrlLenght);
